...
public class BookS {
    ...
    public void addBook (String bookName, Author bookAuthor, String bookGenre, String bookISBN, String year)  throws SQLException, ParseException {
    ...
    public void SetGenre(String nameGenre)  throws SQLException{
        JavaToMySQL jsql = new JavaToMySQL();
        jsql.connectToServer();
    ...
    // Удаление жанра
    public void deleteGenre(String nameGenre)  throws SQLException{
        JavaToMySQL jsql = new JavaToMySQL();
        jsql.connectToServer();
    ...
    public BookS getBook(String nameBook)  throws SQLException{
        JavaToMySQL jsql = new JavaToMySQL();
        jsql.connectToServer();
